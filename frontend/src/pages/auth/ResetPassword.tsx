        ...
        <div className="w-full h-screen bg-linear-to-br from-slate-950 via-slate-900 to-slate-800 flex items-center justify-center px-4">
            ...
            >
                ...
                <div className="text-center mb-8">
                    ...
                    <h2 className="text-2xl font-bold mt-4 tracking-light text-white">
                        Reset Password
                    </h2>
                ...
                <form onSubmit={handleReset} className="space-y-5">
                    ...
                    {message && (
                        <div className="w-full bg-emerald-500/10 border border-border-emerald-500/40 text-emerald-400 text-sm p-3 rounded-lg text-center">
                            {message}
                        </div>
                    )}
                ...
                <p className="text-sm text-center text-gray-400 mt-6">
                    Back to {" "}
                    <Link to="/" className="text-indigo-400 hover:text-indigo-300 transition">Login</Link>
                </p>
